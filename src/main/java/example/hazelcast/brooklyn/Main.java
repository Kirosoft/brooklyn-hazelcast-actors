...
import example.hazelcast.actors.ActorRuntime;
import example.hazelcast.actors.ActorService;
import example.hazelcast.actors.ActorServiceConfig;
import example.hazelcast.actors.EchoActor;
import example.hazelcast.actors.rest.ActorApplication;
